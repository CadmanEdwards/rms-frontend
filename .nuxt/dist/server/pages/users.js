...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/User.vue?vue&type=template&id=3a5b3e5c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-data-table',{staticClass:"elevation-1",attrs:{"headers":_vm.headers,"items":_vm.data},scopedSlots:_vm._u([{key:"top",fn:function(){return [_c('v-toolbar',{attrs:{"flat":""}},[_c('v-toolbar-title',[_vm._v(_vm._s(_vm.Entity)+" List")]),_vm._v(" "),_c('v-divider',{staticClass:"mx-4",attrs:{"inset":"","vertical":""}}),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-dialog',{attrs:{"max-width":"800px"},scopedSlots:_vm._u([{key:"activator",fn:function(ref){
var on = ref.on;
var attrs = ref.attrs;
return [_c('v-btn',_vm._g(_vm._b({staticClass:"mb-2",attrs:{"small":"","color":"primary","dark":""}},'v-btn',attrs,false),on),[_vm._v("\n            New "+_vm._s(_vm.Entity)+"\n          ")])]}}]),model:{value:(_vm.dialog),callback:function ($$v) {_vm.dialog=$$v},expression:"dialog"}},[_vm._v(" "),_c('v-card',[_c('v-card-title',[_c('span',{staticClass:"text-h5"},[_vm._v(_vm._s(_vm.formTitle)+" "+_vm._s(_vm.Entity))])]),_vm._v(" "),_c('v-card-text',[_c('v-container',[_c('v-row',[_c('v-col',{attrs:{"cols":"12","sm":"12","md":"6"}},[_c('v-text-field',{attrs:{"label":_vm.labels.name},model:{value:(_vm.editedItem.name),callback:function ($$v) {_vm.$set(_vm.editedItem, "name", $$v)},expression:"editedItem.name"}})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","sm":"12","md":"6"}},[_c('v-text-field',{attrs:{"type":"email","label":_vm.labels.email},model:{value:(_vm.editedItem.email),callback:function ($$v) {_vm.$set(_vm.editedItem, "email", $$v)},expression:"editedItem.email"}})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","sm":"12","md":"6"}},[_c('v-text-field',{attrs:{"type":"password","label":_vm.labels.password},model:{value:(_vm.editedItem.password),callback:function ($$v) {_vm.$set(_vm.editedItem, "password", $$v)},expression:"editedItem.password"}})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","sm":"12","md":"6"}},[_c('v-text-field',{attrs:{"type":"password","label":_vm.labels.password_confirmation},model:{value:(_vm.editedItem.password_confirmation),callback:function ($$v) {_vm.$set(_vm.editedItem, "password_confirmation", $$v)},expression:"editedItem.password_confirmation"}})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","sm":"12","md":"12"}},[_c('v-autocomplete',{attrs:{"label":"Select Role","items":_vm.roles,"item-text":"role","item-value":"id"},model:{value:(_vm.editedItem.role_id),callback:function ($$v) {_vm.$set(_vm.editedItem, "role_id", $$v)},expression:"editedItem.role_id"}})],1),_vm._v(" "),_c('v-col',_vm._l((_vm.errors),function(e,i){return _c('ul',{key:i},[_c('li',{staticClass:"red--text"},[_vm._v("\n                        "+_vm._s(e)+"\n                    ")])])}),0)],1)],1)],1),_vm._v(" "),_c('v-card-actions',[_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"color":"red darken-1","dark":"","small":""},on:{"click":_vm.close}},[_vm._v("\n              Cancel\n            ")]),_vm._v(" "),_c('v-btn',{attrs:{"color":"blue darken-1","dark":"","small":""},on:{"click":_vm.save}},[_vm._v("\n              Save\n            ")])],1)],1)],1),_vm._v(" "),_c('v-dialog',{attrs:{"max-width":"500px"},model:{value:(_vm.dialogDelete),callback:function ($$v) {_vm.dialogDelete=$$v},expression:"dialogDelete"}},[_c('v-card',[_c('v-card-title',{staticClass:"text-h5"},[_vm._v("Are you sure you want to delete this item?")]),_vm._v(" "),_c('v-card-actions',[_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"color":"blue darken-1","small":"","dark":""},on:{"click":_vm.closeDelete}},[_vm._v("Cancel")]),_vm._v(" "),_c('v-btn',{attrs:{"color":"red darken-1","small":"","dark":""},on:{"click":_vm.deleteItemConfirm}},[_vm._v("OK")]),_vm._v(" "),_c('v-spacer')],1)],1)],1)],1)]},proxy:true},{key:"item.role",fn:function(ref){
var item = ref.item;
return [(item.role && item.role.role)?_c('v-chip',{staticClass:"ma-1 primary"},[_vm._v("\n\n       "+_vm._s(item.role.role)+"\n\n     ")]):_c('v-chip',{attrs:{"dark":""}},[_vm._v("No Role")])]}},{key:"item.actions",fn:function(ref){
var item = ref.item;
return [_c('v-btn',{staticClass:"info--text",attrs:{"mall":"","text":""},on:{"click":function($event){return _vm.editItem(item)}}},[_c('v-icon',{staticClass:"mr-2",attrs:{"x-small":""}},[_vm._v("\n      mdi-pencil\n    ")]),_vm._v("\n    Edit\n    ")],1),_vm._v(" "),_c('v-btn',{staticClass:"error--text",attrs:{"small":"","text":""},on:{"click":function($event){return _vm.deleteItem(item)}}},[_c('v-icon',{attrs:{"color":"error","small":""}},[_vm._v("\n      mdi-delete\n      ")]),_vm._v("\n    delete")],1)]}},{key:"no-data",fn:function(){return [_c('v-btn',{attrs:{"color":"primary"},on:{"click":_vm.initialize}},[_vm._v("\n      Reset\n    ")])]},proxy:true}])})}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/User.vue?vue&type=template&id=3a5b3e5c&
  ...
  methods: {
    ...
    deleteItemConfirm() {
      this.$axios.delete(`/${this.model}/${this.editedItem.id}`).then(res => {
        ...
        this.closeDelete();
        this.$swal.fire(res.data.message, '', 'error');
      });
    },
...
var VAutocomplete = __webpack_require__(224);
...
/* harmony default export */ var VAutocomplete_VAutocomplete = (VSelect["a" /* default */].extend({
  ...
  methods: {
    ...
    changeSelectedIndex(keyCode) {
      ...
      if (this.multiple && keyCode === helpers["w" /* keyCodes */].left) {
        if (this.selectedIndex === -1) {
          this.selectedIndex = this.selectedItems.length - 1;
        } else {
          this.selectedIndex--;
        }
      } else if (this.multiple && keyCode === helpers["w" /* keyCodes */].right) {
        if (this.selectedIndex >= this.selectedItems.length - 1) {
          this.selectedIndex = -1;
        } else {
          this.selectedIndex++;
        }
      } else if (keyCode === helpers["w" /* keyCodes */].backspace || keyCode === helpers["w" /* keyCodes */].delete) {
    ...
    onKeyDown(e) {
      ...
      if (e.ctrlKey || ![helpers["w" /* keyCodes */].home, helpers["w" /* keyCodes */].end].includes(keyCode)) {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/users.vue?vue&type=template&id=18e69786&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('User')}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/users.vue?vue&type=template&id=18e69786&
...
installComponents(component, {User: __webpack_require__(227).default})
